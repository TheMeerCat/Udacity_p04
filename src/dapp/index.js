...
(async () => {
    const FLIGHTS = [
        { flight: "A", timestamp: new Date(2023, 2, 1) },
        { flight: "B", timestamp: new Date(2023, 3, 4) },
        { flight: "C", timestamp: new Date(2023, 4, 2) },
        { flight: "D", timestamp: new Date(2023, 4, 11) },
        { flight: "E", timestamp: new Date(2023, 5, 12) },
        { flight: "F", timestamp: new Date(2023, 6, 5) },
        { flight: "G", timestamp: new Date(2023, 7, 22) },
    ];
